              ...
              <div className="relative" style={{ zIndex: 2 }}>
                ...
                {/* HERO */}
                      <section className="flex flex-col items-center justify-center text-center px-6 pt-24 pb-32 min-h-[88vh]">
                                ...
                                <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 max-w-4xl leading-tight drop-shadow-2xl">
                                            ...
                                            <span className="text-brand-400">geopolitico</span>span>{' '}
                                            para importadores
                                </h1>h1>
                ...
                {/* FEATURES */}
                      <section className="px-6 py-20 bg-slate-950/70 backdrop-blur-sm border-t border-slate-800/40">
                          ...
                          <div key={title} className="card p-5 hover:border-brand-700/50 transition-colors bg-slate-900/60 backdrop-blur-sm">
                                            ...
                                            <h3 className="font-semibold text-white mb-2">{title}</h3>h3>
                ...
                {/* PRICING */}
                      <section className="px-6 py-20 bg-slate-900/50 backdrop-blur-sm border-t border-slate-800/40">
                                <div className="max-w-5xl mx-auto">
                                            <h2 className="text-3xl font-bold text-white text-center mb-3">Precios simples y transparentes</h2>h2>
                                            <p className="text-slate-400 text-center mb-12">Comienza gratis. Sin tarjeta de credito.</p>p>
                          ...
                          <div key={plan.name} className={`card p-6 flex flex-col bg-slate-900/60 backdrop-blur-sm ${plan.highlight ? 'border-brand-500/60 ring-1 ring-brand-500/20' : ''}`}>
                            {plan.highlight && (
                                            ...
                                            <h3 className="font-bold text-white text-xl mb-1">{plan.name}</h3>h3>
                                            <div className="flex items-end gap-1 mb-5">
                                                                <span className="text-3xl font-bold text-white">${plan.price}</span>span>
                                                                <span className="text-slate-400 text-sm mb-1">/mes</span>span>
                                            </div>div>
                ...
                {/* FOOTER */}
                      <footer className="border-t border-slate-800/40 px-6 py-8 text-center bg-slate-950/80 backdrop-blur-sm">
                                ...
                                <p className="text-slate-500 text-sm">Inteligencia geopolitica para el comercio internacional</p>p>
                                <p className="text-slate-600 text-xs mt-2">2025 GeoPulse. Todos los derechos reservados.</p>p>
                      </footer>footer>
